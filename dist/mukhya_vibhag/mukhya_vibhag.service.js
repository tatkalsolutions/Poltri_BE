...
exports.MukhyaVibhagService = void 0;
const common_1 = require("@nestjs/common");
const sql_sql_1 = require("../database/sql.sql");
let MukhyaVibhagService = class MukhyaVibhagService {
    constructor(sql) {
        this.sql = sql;
    }
    ...
    async mukhyaVibhagInsert(dsHeader, dsFINAcPost, dsRefHeader, dsRefACPost) {
        ...
        if (TRAN_NO != undefined) {
            ...
            await this.sql.executeQuery(`delete from TRNACCTPOST where TRAN_NO= ${dsHeader.TRAN_NO}`);
            ...
            dsHeader['REFCOMPUNIT_ID'] = (dsHeader === null || dsHeader === void 0 ? void 0 : dsHeader.REFCOMPUNIT_ID) == undefined ? 0 : dsRefHeader === null || dsRefHeader === void 0 ? void 0 : dsRefHeader.COMPANY_ID;
            ...
            if (dsRefACPost != undefined) {
                if (((_a = Object.keys(dsRefACPost)) === null || _a === void 0 ? void 0 : _a.length) != 0) {
                    ...
                    queryArray.push(res2);
                    if (((_b = Object.keys(dsRefACPost)) === null || _b === void 0 ? void 0 : _b.length) != 0) {
                        let SR_NO = 1;
    ...
    async mukhyaVibhagTwoObj_Insert(dsHeader, dsACPost, dsRefHeader, dsRefACPost) {
        let queryArray = new Array();
        let ex_RefTranNo;
        let sysDate = await this.sql.executeQuery(`Get_SYSDATETIME`);
        let RefTranNo = 0;
    ...
    async kharchMagniVouchrInsert(dsHeader, dsACPost, dsRefHeader, dsRefACPost) {
        let queryArray = new Array();
        let ex_RefTranNo;
        let sysDate = await this.sql.executeQuery(`Get_SYSDATETIME`);
        let RefTranNo = 0;
...
exports.MukhyaVibhagService = MukhyaVibhagService;
exports.MukhyaVibhagService = MukhyaVibhagService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [sql_sql_1.SQL])
], MukhyaVibhagService);
//# sourceMappingURL=mukhya_vibhag.service.js.map